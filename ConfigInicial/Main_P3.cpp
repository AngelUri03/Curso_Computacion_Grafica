...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Práctica 3 Morales Galicia Angel Uriel", nullptr, nullptr);
 ...
 //     
	...
	projection = glm::perspective(45.0f, (GLfloat)screenWidth / (GLfloat)screenHeight, 0.1f, 105.0f);//FOV, Radio de aspecto,znear,zfar
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate( model, 0.2f, glm::vec3(0.0f, -1.0f, 0.0f ) ); // use to compare orthographic and perspective projection
