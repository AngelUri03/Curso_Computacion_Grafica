...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo #9 Fuentes de luz Morales Galicia Angel Uriel", nullptr, nullptr);
	...
	Model Harry((char*)"Models/harry.obj");
