...
glm::vec3 lightPos2(0.0f, 1.0f, 2.0f);
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo #8 Materiales e Iluminacion Morales Galicia Angel Uriel", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light[0].specular"), 0.3f, 0.6f, 0.4f);

        // Luz 2
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light[1].position"), light2Pos.x, light2Pos.y, light2Pos.z);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light[1].ambient"), 0.3f, 0.3f, 0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light[1].diffuse"), 0.7f, 0.2f, 0.2f); // Luz roja
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light[1].specular"), 0.6f, 0.6f, 0.6f);
